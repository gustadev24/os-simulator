...
TEST_CASE("Priority Scheduler - Basic Operations", "[priority]") {
  ...
  SECTION("Add single process") {
    processes.push_back(std::make_shared<Process>(1, "P1", 0, 10, 5));
...
TEST_CASE("Priority Scheduler - Priority Order", "[priority]") {
  ...
  SECTION("Lower priority number = higher priority") {
    processes.push_back(std::make_shared<Process>(1, "P1", 0, 10, 5));
    processes.push_back(std::make_shared<Process>(2, "P2", 0, 5, 1));
    processes.push_back(std::make_shared<Process>(3, "P3", 0, 8, 3));
  ...
  SECTION("Equal priority - arrival time breaks tie") {
    processes.clear();
    processes.push_back(std::make_shared<Process>(1, "P1", 2, 10, 3));
    processes.push_back(std::make_shared<Process>(2, "P2", 0, 5, 3));
    processes.push_back(std::make_shared<Process>(3, "P3", 1, 8, 3));
  ...
  SECTION("Mixed priorities") {
    processes.clear();
    processes.push_back(std::make_shared<Process>(1, "P1", 0, 10, 0));
    processes.push_back(std::make_shared<Process>(2, "P2", 0, 5, 10));
    processes.push_back(std::make_shared<Process>(3, "P3", 0, 8, 5));
    processes.push_back(std::make_shared<Process>(4, "P4", 0, 3, 2));
...
TEST_CASE("Priority Scheduler - Edge Cases", "[priority]") {
  ...
  SECTION("All same priority and arrival time") {
    processes.push_back(std::make_shared<Process>(1, "P1", 0, 10, 5));
    processes.push_back(std::make_shared<Process>(2, "P2", 0, 5, 5));
    processes.push_back(std::make_shared<Process>(3, "P3", 0, 8, 5));
