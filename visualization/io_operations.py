...
class IOOperationsGenerator(BaseGenerator):
    ...
    def _draw_io_timeline(
        self, ax: plt.Axes, io_periods: Dict[str, List[Dict[str, Any]]]
    ) -> None:
        """
        ...
        self.style_axis(
            ...
            xlabel="Tiempo (ticks)",
            ylabel="Proceso",
            title="Línea Temporal de Operaciones E/S (Períodos Bloqueados)",
            grid_axis="x",
        )
    ...
    def _set_common_xrange(
        self,
        ax1: plt.Axes,
        ax2: plt.Axes,
        io_periods: Dict[str, List[Dict[str, Any]]],
